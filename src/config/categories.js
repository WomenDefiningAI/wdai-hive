...
const MESSAGE_TEMPLATES = {
  weekly_checkin: {
    ...
    description: "Hey there! It's time for your weekly AI check-in. Have you played with AI this week?",
    ai_definition: "Playing with AI means experimenting with AI tools, building something using AI, exploring new AI features, or learning about AI concepts. It could be as simple as trying a new prompt or as complex as building an AI-powered application!",
    yes_button: "Yes, I played with AI! 🎉",
    no_button: "Not this week 😔"
  },
  category_selection: {
    title: "What did you work on?",
    description: "Great! Let's capture what you explored. What category best describes your AI activity?",
    next_button: "Next ➡️"
  },
  tool_selection: {
  ...
  thank_you: {
    ...
    description: "Your AI adventure has been recorded in the WDAI Hive. Keep exploring and inspiring others!"
  },
  no_response: {
    title: "No worries! 😊",
